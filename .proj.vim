...
badd +0 test.js
badd +0 mainjs.html
badd +0 data/gov-spend-2012.json
badd +0 data/test.json
argglobal
silent! argdel *
set stal=2
edit test.js
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 86 - ((20 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 12 - ((10 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
...
exe '4resize ' . ((&lines * 22 + 25) / 50)
exe 'vert 4resize ' . ((&columns * 79 + 79) / 159)
tabedit data/gov-spend-2012.json
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
